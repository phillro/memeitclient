...
module.exports = MemeItCall;
function MemeItCall(params, options) {
    var self = this
...
util.inherits(MemeItCall, events.EventEmitter);

MemeItCall.prototype.exec = function() {
    var self = this
    var reqOptions = {
 ...
 * @param callback
 */
MemeItCall.prototype.data = function(callback) {
 ...
 * @param callback
 */
MemeItCall.prototype.done = function(callback) {
 ...
 * @param callback
 */
MemeItCall.prototype.error = function(callback) {
